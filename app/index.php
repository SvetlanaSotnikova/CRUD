        ...
        <div class="row">
            <div class="col-12">
                <button class="btn btn-success mt-2" data-bs-toggle="modal" data-bs-target="#create">
                    <i class="bi bi-plus-lg"><img src="../img/plus-solid.svg" width="15" alt=""></i>
                </button>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $value -> name; ?></td>
                            <td><?= $value -> email;?></td>
                            <td><a href="?id = <?= $value -> id;?>" class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#edit<?= $value -> id;?>"><i class="bi bi-pencil-square"><svg
