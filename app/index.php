                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="?id = <?php echo $value -> id;?>" class="btn btn-success"
                                    data-bs-toggle="modal" data-bs-target="#edit<?php echo $value -> id;?>"><i
                                ...
                                <a href="?id = <?php echo $value -> id;?>" class="btn btn-danger" data-bs-toggle="modal"
                                    data-bs-target="#delete<?php echo $value -> id;?>"><i class="bi bi-trash"><svg
